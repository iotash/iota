...
// Go: internal/markdown/markdown_test.go:1433 — a fence with no language carries NO
// color sequences even with the Monokai theme active: the terminal's default
// foreground is readable on any background.
#[test]
fn test_bare_fence_uses_default_foreground() {
...
// Go: internal/markdown/markdown_test.go:152 — the unified Flush contract: the final
...
#[test]
fn test_flush_partial_line_dispatch() {
...
// Go: internal/markdown/markdown_test.go:244 TestCodeBlockRender — the T1 subset
...
#[test]
fn test_code_block_render_plain() {
