> **归档（2026-09-15）。** 本文描述的是 2026-09-08 的判断。此后 Go 树退役、仓库迁入 `iotash`、CLI 改为
> agent-first、Windows 已支持、0.1.0 与 0.2.0 已发布；67 条步骤里 17 条已完成、11 条前提消失。
> 现行路线图是 `docs/ROADMAP.md`，它引用本文的章节号（§2.4、§2.5、§3、Phase 4/5 步骤）作为分析依据。
